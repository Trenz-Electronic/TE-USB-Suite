...
;;; Modified by KNK for USBserial project
;;;-----------------------------------------------------------------------------
...
;; Virtual COM Port COMM Interface Descriptor
        ...
        .db        1                ; bNumEndpoints
        .db        0x02             ; bInterfaceClass (vendor specific)
        .db        0x02             ; bInterfaceSubClass (vendor specific)
        .db        0x01             ; bInterfaceProtocol (vendor specific)
...
;; Data IN Endpoint descriptor
        ...
        .db     <EP_SIZE           	;; wMaxPacketSize (LSB)
        .db     >EP_SIZE           	;; wMaxPacketSize (MSB)
...
_full_speed_device_descr::        
        ...
        .db        <USB_VER         ; Specification version (LSB)
        .db        >USB_VER         ; Specification version (MSB)
        .db        0x02             ; device class (vendor specific)
...
;; Control Endpoint (EP1IN) Descriptor
        .db     DSCR_ENDPNT_LEN
        .db     DSCR_ENDPNT
...
;; Virtual COMM Port Interface
		...
		.db		SI_PRODUCT			;; Interface descriptor string index
