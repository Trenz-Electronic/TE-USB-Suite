...
__sfr __at 0x80 IOA;
		...
		__sbit __at 0x80+4 IOA4;
		__sbit __at 0x80+5 IOA5;
		__sbit __at 0x80+6 IOA6;
		__sbit __at 0x80+7 IOA7;
__sfr __at 0x81 SP;
__sfr __at 0x82 DPL;
__sfr __at 0x83 DPH;
...
__sfr __at 0x8E CKCON;
         ...
         //sbit T1M    = 0x89+4;
         //sbit T2M    = 0x89+5;
// ____sfr __at 0x8F SPC_FNC; // Was WRS in Reg320
         /*  CKCON  */
         //sbit WRS    = 0x8F+0;
__sfr __at 0x90 IOB;
...
__sfr __at 0xB0 IOD;
		__sbit __at 0xB0+0 IOD0;
		__sbit __at 0xB0+1 IOD1;
		__sbit __at 0xB0+2 IOD2;
		__sbit __at 0xB0+3 IOD3;
		__sbit __at 0xB0+4 IOD4;
		__sbit __at 0xB0+5 IOD5;
		__sbit __at 0xB0+6 IOD6;
		__sbit __at 0xB0+7 IOD7;
__sfr __at 0xB1 IOE;
__sfr __at 0xB2 OEA;
__sfr __at 0xB3 OEB;
__sfr __at 0xB4 OEC;
