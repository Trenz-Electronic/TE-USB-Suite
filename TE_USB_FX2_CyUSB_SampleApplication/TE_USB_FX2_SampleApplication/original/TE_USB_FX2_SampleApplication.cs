...
namespace TE_USB_FX2_SampleApplication
{
    ...
    class TE_USB_FX2_SampleApplication
    {
        ...
        static void DrawMenu()
        {
            ...
            Console.WriteLine("    11 - Read high speed data performance (without FPGA RX, FX2 only)");
            Console.WriteLine("    12 - Write high speed data performance (without FPGA TX, FX2 only)");
        ...
        public static bool SendFPGAcommand(ref CyUSBDevice TE_USB_FX2_USBDevice, MB_Commands Command , uint Timeout)
        {
            ...
            cmd_FX22MB_REG0[1] = (byte)FX2_Commands.I2C_MICROBLAZE_ADDRESS;
            cmd_FX22MB_REG0[2] = (byte)FX2_Commands.I2C_BYTES;
        ...
        static void GetFPGAversion(CyUSBDevice TE_USB_FX2_USBDevice)
        {
            ...
            //Command[1] = (byte)FX2_Commands.I2C_MICROBLAZE_ADDRESS;
            //Command[2] = (byte)FX2_Commands.I2C_BYTES;
            Command[3] = (byte)MB_Commands.FX22MB_REG0_NOP; //0;
            Command[4] = (byte)MB_Commands.FX22MB_REG0_NOP; //0;
            Command[5] = (byte)MB_Commands.FX22MB_REG0_NOP; //0;
        ...
        static void ReadDataFPGAIntegrity(CyUSBDevice TE_USB_FX2_USBDevice, int BUFFER_SIZE, int PACKETSNUMBER, int PACKETLENGTH, uint TIMEOUT_MS)
        {
            ...
            //ResetFX2FifoStatus(TE03xx_USBdevice);
        ...
        static void ReadDataFX2Performance(CyUSBDevice TE_USB_FX2_USBDevice, int BUFFER_SIZE, int PACKETSNUMBER, int PACKETLENGTH, uint TIMEOUT_MS)
        {
            if (TE_USB_FX2_USBDevice == null)
            {
                Console.WriteLine("Error,no device is selected");
            ...
            //int PACKETLENGTH = 300;//102400;//102400;//1228800;//1638400;//512;

            //int PACKETSNUMBER = 200;//1200;
            ...
            //Console.WriteLine("Read test passed");
            //Console.WriteLine(" {0:X}", data);
            Console.WriteLine("Packet Errors {0}", errors);
            ...
            if (errors >= 1) Console.WriteLine("memory->host data verification FAILED: {0} Packet ERRORS", errors);
            else Console.WriteLine("memory->host data verification PASSED!!!");
        ...
        static void WriteDataFX2Performance(CyUSBDevice TE_USB_FX2_USBDevice)
        {
            ...
            byte[] data = new byte[packetlen];  //packetlen*packets //
            //allocate memory
            ...
            //the FPGA verify the data integrity of data transmitted
            //int status = GetFPGAstatus(ref TE_USB_FX2_USBDevice);
               ...
               try
               {
                switch (m_sel)
                {
                    ...
                    case 10:
                        ...
                        break;
                    case 11:
                        //ReadDataFX2Performance(TE_USB_FX2_USBDevice);
                        break;
                    case 12:
                        //WriteDataFX2Performance(TE_USB_FX2_USBDevice);
                        break;
                }
               }
